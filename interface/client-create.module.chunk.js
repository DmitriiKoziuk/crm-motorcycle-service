...
var ClientCreateComponent = (function () {
    ...
    ClientCreateComponent.prototype.addVehicle = function () {
        this.clientRecord.addVehicle(this._selectedVehicle, this.vehicleForm.get('vin').value, this.vehicleForm.get('note').value);
    };
    ClientCreateComponent.prototype.selectedVehicle = function (vehicle) {
        return vehicle ? vehicle.getFullName() : undefined;
    };
    ClientCreateComponent.prototype.changeVehicle = function (event) {
